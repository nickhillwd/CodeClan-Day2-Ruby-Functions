...
cube_vol_result = cube_vol(2)
puts "Result is #{cube_vol_result} expected: 27"
...
sphere_volume_result = sphere_volume(10)
puts "Result is #{sphere_volume_result}"
...
puts "night left untill xmas = #{nights_to_xmas}!! Ho Ho Ho!!!"

####Given a date of birth, calculate how old a person born on that date would be

puts "Whats your date of birth? __/__/____:"
